...
public class Deal extends RepresentationModel<Deal>   {
  @JsonProperty("dealId")
  private UUID dealId;
  ...
  private LawOrderFeeRateTypeEnum lawOrderFeeRateType = LawOrderFeeRateTypeEnum._;
  ...
  */
  ...
  public Deal date(LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  */
  ...
  public Deal debtItems(List<DebtItem> debtItems) {
    this.debtItems = debtItems;
    return this;
  }

  public Deal addDebtItemsItem(DebtItem debtItemsItem) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.dealId, deal.dealId) &&
        ...
        Objects.equals(this.debtItems, deal.debtItems);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dealId, numebr, date, fund, lawOrderFund, lawOrderFundRate, lawOrderCreditRate, lawOrderFeeRate, lawOrderFeeRateType, debtItems);
  }
